...
import org.apache.carbondata.store.impl.ObjectSerializer;
...
public class ScanResponse extends BaseResponse implements Serializable, Writable {
  ...
  public void write(DataOutput out) throws IOException {
    ...
    WritableUtils.writeCompressedByteArray(out, ObjectSerializer.serialize(rows));
  }
  ...
  public void readFields(DataInput in) throws IOException {
    ...
    queryId = in.readInt();
    try {
      rows = (Object[][])ObjectSerializer.deserialize(
