...
public class Worker {
  ...
  private static Logger LOGGER = LogServiceFactory.getLogService(Worker.class.getName());
  ...
  private void startService() throws IOException {
    ...
    if (exception != null) {
      ...
      LOGGER.error("worker failed to start", exception);
      throw exception;
    }
  ...
  private void registerToMaster() throws IOException {
    ...
    try {
      ...
      LOGGER.error("worker failed to register", throwable);
