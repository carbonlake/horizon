...
import org.apache.carbondata.store.core.CarbonStore;
import org.apache.carbondata.store.core.KeyedRow;
import org.apache.carbondata.store.core.PrimaryKey;
import org.apache.carbondata.store.core.Row;
...
import org.apache.carbondata.store.core.util.StoreUtil;
...
public class LocalCarbonStore extends MetaOperation implements CarbonStore {
  ...
  public void loadData(LoadDescriptor load) throws CarbonException {
    ...
    try {
      ...
      LOGGER.error("Invalid loadDescriptor options", e);
    ...
    try {
      ...
      try {
        ...
        LOGGER.error("Failed to close segment", ex);
